  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed right-0 top-0 z-50 flex h-full w-[82%] max-w-xs flex-col border-l border-border bg-bg shadow-[-24px_0_48px_-12px_rgb(var(--color-text-rgb)/0.25)] data-[state=open]:animate-in data-[state=open]:slide-in-from-right"
